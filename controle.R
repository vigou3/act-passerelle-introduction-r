...
## Exemple de test si vrai est vrai. Le résultat de 'all' est
## déjà TRUE ou FALSE, alors pas besoin de vérifier si TRUE ==
## TRUE ou si FALSE == TRUE.
if (all(x > 0) == TRUE) x + 2 else x^2
